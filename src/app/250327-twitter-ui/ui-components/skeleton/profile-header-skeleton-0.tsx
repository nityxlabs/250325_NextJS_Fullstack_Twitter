...
export function ProfileHeaderSkeletonMokha(): React.JSX.Element {
  return (
    <div className="w-full flex flex-col gap-2 my-2 p-4">
      <div className="flex gap-2 items-center">
        <div className="flex flex-1 gap-1">
          <SkeletonLoaderElement className="h-4 w-12 rounded-full" />
          <SkeletonLoaderElement className="h-4 w-16 rounded-full" />
          <SkeletonLoaderElement className="h-40 w-full relative" />
          <p>I Think I need a child Skeleton Loader</p>

          <SkeletonLoaderElement className="h-6 mt-4 w-24 ml-auto rounded-full" />
          <SkeletonLoaderElement className="h-4 w-14 rounded-full mt-4" />
          <SkeletonLoaderElement className="h-4 w-20 rounded-full" />
          <SkeletonLoaderElement className="h-4 w-2/3 rounded-full" />
        </div>
      </div>
    </div>
  );
